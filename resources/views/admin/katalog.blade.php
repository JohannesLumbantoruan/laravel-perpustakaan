            ...
            <div class="card-body">
                ...
                @foreach ($buku as $b)
                    <div class="col-md-3 mb-3">
                        <img src="{{ ('/cover/'. $b->cover) }}" alt="cover_buku" class="card-img-top" style="height: 150px">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ route('adminDetailBuku', $b->id) }}" class="link"><h5 class="card-title"><?php if (strlen($b->judul) > 30){$b->judul = substr($b->judul, 0, 30)."...";} ?> {{ $b->judul }}</h5></a>
