    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('adminFilterLaporanPeminjaman') }}" method="GET">
                                    <div class="form-group">
                                        <label for="tanggal_mulai" class="font-weight-bold">Tanggal Mulai Peminjaman</label>
                                        <input type="date" name="tanggal_mulai" class="form-control" placeholder="Masukkan tanggal mulai peminjaman">
                ...
                <a href="{{ route('adminCetakLaporan') }}" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a>
                <br><br>
